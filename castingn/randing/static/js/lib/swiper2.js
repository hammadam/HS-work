...
!function(e, t) {
  ...
  var u = {
      ...
      updateSlides: function() {
          ...
          if (void 0 !== s) {
              ...
              e.slidesPerColumn > 1 && (T = Math.floor(p / e.slidesPerColumn) === p / this.params.slidesPerColumn ? p : Math.ceil(p / e.slidesPerColumn) * e.slidesPerColumn,
              ...
              for (var C, M = e.slidesPerColumn, z = T / M, k = z - (e.slidesPerColumn * z - p), P = 0; P < p; P += 1) {
                  ...
                  if (e.slidesPerColumn > 1) {
                      var L = void 0
                        , I = void 0
                        , D = void 0;
                      "column" === e.slidesPerColumnFill ? (D = P - (I = Math.floor(P / M)) * M,
                      (I > k || I === k && D === M - 1) && (D += 1) >= M && (D = 0,
                      I += 1),
                      L = I + D * T / M,
                      $.css({
                  ...
                  if ("none" !== $.css("display")) {
                      ...
                      u.push(y)) : (E % e.slidesPerGroup == 0 && c.push(y),
                      u.push(y),
                      y = y + S + w),
  ...
  var m = {
      ...
      slidePrev: function(e, t, i) {
          ...
          var l, d = o ? this.translate : -this.translate, h = d < 0 ? -Math.floor(Math.abs(d)) : Math.floor(d), p = r.map(function(e) {
              return Math.floor(e)
          }), c = (n.map(function(e) {
              return Math.floor(e)
          }),
          r[p.indexOf(h)],
          r[p.indexOf(h) - 1]);
          return void 0 !== c && (l = n.indexOf(c)) < 0 && (l = this.activeIndex - 1),
          ...
          this.onTouchEnd = function(e) {
              ...
              s.freeMode) {
                  ...
                  for (var z = 0, k = t.slidesSizesGrid[0], P = 0; P < o.length; P += s.slidesPerGroup)
                      void 0 !== o[P + s.slidesPerGroup] ? p >= o[P] && p < o[P + s.slidesPerGroup] && (z = P,
                      k = o[P + s.slidesPerGroup] - o[P]) : p >= o[P] && (z = P,
